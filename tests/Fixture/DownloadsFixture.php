...
class DownloadsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pdf_link' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'pdf_link' => 'Lorem ipsum dolor sit amet',
                'status' => 1
            ],
        ];
        parent::init();
