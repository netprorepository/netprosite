...
<?=$this->Html->image('/projectimg/'.$product->productimage, ['alt' => 'NetPro product','class'=>'width-100'])?>
                        ...
                        <div class="blog-detail-page-inner bg-white">
                            ...
                            <h4 class="fontface-one font-weight-600 text-color-dark padding-bottom-30"><?=$product->name?></h4>
